...
export interface PuffySupportIconProps {
  size?: number;
  color?: string;
  focused?: boolean;
}

export function PuffySupportIcon({
  size = 24,
  color = '#000',
  focused = true,
}: PuffySupportIconProps): React.JSX.Element {
  // Bootstrap `bi-patch-question-fill` (16x16) path.
