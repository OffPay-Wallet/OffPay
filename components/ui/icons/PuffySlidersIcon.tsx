...
export interface PuffySlidersIconProps {
  size?: number;
  color?: string;
  focused?: boolean;
}

export function PuffySlidersIcon({
  size = 24,
  color = colors.text.primary,
  focused = true,
}: PuffySlidersIconProps): React.JSX.Element {
  // Bootstrap `bi-sliders2-vertical` (16x16) path.
