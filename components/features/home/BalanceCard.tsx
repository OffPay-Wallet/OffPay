...
const styles = StyleSheet.create({
  ...
  sheetClose: {
    ...
    borderRightWidth: StyleSheet.hairlineWidth,
    borderColor: colors.glass.rim,
    boxShadow: `0 8px 16px rgba(14, 42, 53, 0.1), inset 0 1px 1px rgba(255, 255, 255, 0.86), inset 0 -8px 14px rgba(91, 200, 232, 0.1)`,
  },
  currencySearchBox: {
    flexDirection: 'row',
    alignItems: 'center',
    ...
    borderRightWidth: StyleSheet.hairlineWidth,
    borderColor: colors.glass.rim,
    boxShadow: `inset 0 1px 1px rgba(255, 255, 255, 0.82), inset 0 -8px 16px rgba(91, 200, 232, 0.12)`,
    paddingHorizontal: spacing.md,
    height: 42,
    marginBottom: spacing.md,
  },
  ...
  currencyOption: {
    ...
    borderRightWidth: StyleSheet.hairlineWidth,
    borderColor: colors.glass.rimSubtle,
    boxShadow: `0 8px 18px rgba(14, 42, 53, 0.06), inset 0 1px 1px rgba(255, 255, 255, 0.86), inset 0 -8px 16px rgba(91, 200, 232, 0.08)`,
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    gap: spacing.md,
