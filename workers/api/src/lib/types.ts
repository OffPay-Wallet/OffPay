...
export type Bindings = {
  ...
  OFFPAY_RWA_JUPITER_STOCKS_ALLOWLIST?: string;
  OFFPAY_RWA_JUPITER_STOCK_SEARCH_QUERIES?: string;
  OFFPAY_RWA_ISSUER_API_BASE_URL?: string;
  OFFPAY_RWA_MAINNET_ENABLED?: string;
  OFFPAY_FLASH_V2_ENABLED?: string;
  OFFPAY_FLASH_V2_API_BASE_URL?: string;
  OFFPAY_FLASH_V2_ER_RPC_URL?: string;
  OFFPAY_RWA_MAINNET_ELIGIBLE_WALLETS?: string;
  OFFPAY_RWA_MAINNET_ELIGIBILITY_POLICY_VERSION?: string;
  OFFPAY_RWA_MAINNET_RESTRICTED_COUNTRIES?: string;
  OFFPAY_RWA_MAX_PRICE_IMPACT_BPS?: string;
  OFFPAY_RWA_DELEGATE_PROGRAM_ID?: string;
  OFFPAY_RWA_DELEGATE_DEVNET_ENABLED?: string;
  OFFPAY_RWA_MAGICBLOCK_ER_DEVNET_RPC_URL?: string;
  OFFPAY_RWA_MAGICBLOCK_ROUTER_DEVNET_URL?: string;
  OFFPAY_RWA_DEVNET_ASSETS_JSON?: string;
  OFFPAY_RWA_DEVNET_SANDBOX_MINT?: string;
  OFFPAY_RWA_DEVNET_SETTLEMENT_MINT?: string;
  OFFPAY_RWA_DEVNET_SANDBOX_SYMBOL?: string;
  OFFPAY_RWA_DEVNET_SANDBOX_NAME?: string;
  OFFPAY_RWA_DEVNET_SANDBOX_DECIMALS?: string;
  OFFPAY_RWA_DEVNET_PRICE_REFERENCE_MINT?: string;
  ...
  OFFPAY_ANDROID_DISTRIBUTION_MODE?: string;
  OFFPAY_ANDROID_CERTIFICATE_SHA256_DIGESTS?: string;
  OFFPAY_ANDROID_MIN_VERSION_CODE?: string;
